...
* Переход на УНФ версии 3.0.12.176
* Добавлена возможность устанавливать минимальную длительность при импорте звонков
* Первоначальное заполнение данных теперь доступно до активации расширенной лицензии
* Настройки подключения к 1С-Коннект перенесены в раздел `УНФФ С&К -> 1С-Коннект -> Настройки подключения`
* Добавлена колонка `Оператор ЭДО` в отчет по тарифам
* Исправление ошибок
...
* Переход на УНФ версии 3.0.11.135
* Добавлен импорт цен номенклатуры с сайта 1С
* Исправление ошибок
