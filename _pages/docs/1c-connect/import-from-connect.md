...
![Созданные документы УВ](../img/task-on-work-document.png)
...
Время выполнения заявки можно увидеть, включив опцию `Время` у отчета УРВ. Для оплаты это время не учитывается и считается за единицу.
